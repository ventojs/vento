...
In this example, the parent template modifies the `value` variable and creates the `foo` variable. These changes are only available in the context of the nested templates.
